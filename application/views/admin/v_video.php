...
<head>
  ...
  <script language="JavaScript">
    var txt = "Video | <?= $profil->nama_puskesmas ?>   ";
    var kecepatan = 450;
    var segarkan = null;
                  ...
                  <table id="example1" class="table table-striped" style="font-size:12px;">
                    ...
                    <tbody>
                      ...
                      foreach ($data->result_array() as $i) :
                        ...
                        $deskripsi_video = $i['deskripsi_video'];
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo $deskripsi_video; ?></td>
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/video/simpan_video' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" name="xnama" class="form-control" id="inputUserName" placeholder="Judul Video" required>
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Deskripsi</label>
              <div class="col-sm-7">
                <textarea class="form-control" rows="3" name="xketerangan" placeholder="Deskripsi ..." required></textarea>
              </div>
            </div>

            <!-- /.form group -->
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Kode Youtube</label>
              <div class="col-sm-7">
                <input type="text" name="xsource" class="form-control" id="inputUserName" placeholder="Kode Youtube" required>
              </div>
            </div>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  ...
                  <input type="text" name="xnama" class="form-control" value="<?php echo $judul_video; ?>" id="inputUserName" placeholder="Judul Video" required>
                </div>
              </div>
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label">Deskripsi</label>
                <div class="col-sm-7">
                  <textarea class="form-control" rows="3" name="xketerangan" placeholder="Deskripsi ..." required><?php echo $deskripsi_video; ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                <label for="inputUserName" class="col-sm-4 control-label">Kode Youtube</label>
                <div class="col-sm-7">
                  <input type="text" name="xsource" class="form-control" value="<?php echo $kode_video; ?>" id="inputUserName" placeholder="Kode Youtube" required>
                </div>
              </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url() . 'admin/video/hapus_video' ?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              <input type="hidden" name="kode" value="<?php echo $id_video; ?>" />
              <p>Apakah Anda yakin mau menghapus <b><?php echo $judul_video; ?></b> ?</p>
