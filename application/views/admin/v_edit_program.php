...
<head>
  ...
  <script language="JavaScript">
    var txt = "Update Post | Puskesmas Sungailiat ";
    var kecepatan = 450;
    var segarkan = null;
        ...
        <div class="box box-default">
          ...
          <form action="<?php echo base_url() . 'admin/program/update_program' ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-10">
                  <input type="hidden" name="kode" value="<?php echo $b['program_id']; ?>">
                  <input type="text" name="xjudul" class="form-control" value="<?php echo $b['program_judul']; ?>" placeholder="Judul Inovasi" required />
                </div>
                <!-- /.col -->
                <div class="col-md-2">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">Inovasi</h3>
              </div>
              <div class="box-body">

                <textarea id="ckeditor" name="xisi" required><?php echo $b['program_isi']; ?></textarea>
