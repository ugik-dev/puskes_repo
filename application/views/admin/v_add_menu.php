...
<head>
  ...
  <script language="JavaScript">
    var txt = "Add Post Artikel | Puskesmas Sungailiat ";
    var kecepatan = 450;
    var segarkan = null;
        ...
        <div class="box box-default">
          ...
          <form action="<?php echo base_url() . $form_url ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-10">
                  <input type="hidden" name="id_menu" value="<?= !empty($return_data) ? $return_data['id_menu'] : ''; ?>" />
                  <input type="text" name="nama_menu" class="form-control" placeholder="Nama Menu" value="<?= !empty($return_data) ? $return_data['nama_menu'] : ''; ?>" required />
                </div>
                <!-- /.col -->
                <div class="col-md-2">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-danger">
              ...
              <div class="box-body">
                ...
                <textarea id="ckeditor" name="konten" rows="5"><?= !empty($return_data) ? $return_data['konten'] : ''; ?></textarea>
            ...
            <div class="box box-primary">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="number" name="no_urut" class="form-control" placeholder="1, 2, 3, 4" value="<?= !empty($return_data) ? $return_data['no_urut'] : ''; ?>" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="kategori" id="kategori" style="width: 100%;" required>
                    ...
                    <option value="poskesdes_pustu">Poskesdes & Pustu</option>
                  </select>
                </div>
                <div class="form-group">
                  <label>Status</label>
