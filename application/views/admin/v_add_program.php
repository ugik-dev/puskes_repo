...
<head>
  ...
  <script language="JavaScript">
    var txt = "Add Post Program Unggulan | <?= $profil->nama_puskesmas ?>  ";
    var kecepatan = 450;
    var segarkan = null;
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Add Program Unggulan</li>
        </ol>
      </section>
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Post Program Unggulan</h3>
          </div>
          ...
          <form action="<?php echo base_url() . 'admin/program/simpan_program' ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-10">
                  <input type="text" name="xjudul" class="form-control" placeholder="Judul Program Unggulan atau Inovasi" required />
                </div>
                <!-- /.col -->
                <div class="col-md-2">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">Program Unggulan</h3>
              </div>
              <div class="box-body">
