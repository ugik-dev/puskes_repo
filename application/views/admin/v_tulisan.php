...
<head>
  ...
  <script language="JavaScript">
    var txt = " Artikel | Puskesmas Sungailiat ";
    var kecepatan = 450;
    var segarkan = null;
                  ...
                  <table id="example1" class="table table-striped" style="font-size:13px;">
                    ...
                    <tbody>
                      ...
                      foreach ($data->result_array() as $i) :
                        ...
                        $kategori_nama = $i['tulisan_jenis'];

                      ?>
                        <tr>
                          <td><img src="<?php echo base_url() . 'upload/images/' . $tulisan_gambar; ?>" style="width:90px;"></td>
                          <td><?php echo $tulisan_judul; ?></td>

                          <td><?php echo $tulisan_tanggal; ?></td>
                          <td><?php echo $tulisan_author; ?></td>
                          <td><?php echo $tulisan_views; ?></td>
                          <td><?php echo $i['tulisan_jenis']; ?></td>
