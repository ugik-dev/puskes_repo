            ...
            <div class="col-lg-9">
                <div class="blog-posts">
                    ...
                    <ul class="pagination float-end">
                        <li class="page-item"><a class="page-link" href="<?= base_url($link .  '?key=' . $dataContent['key'] . '&page=1') ?>">Awal</a></li>
                        <li class="page-item"><a class="page-link" href="<?= base_url($link .  '?key=' . $dataContent['key'] . '&page=' . ($dataContent['page'] - 1)) ?>"><i class="fas fa-angle-left"></i></a></li>
                        <?php
                        ...
                        ?>
                            <li class="page-item <?= $i == $dataContent['page'] ? 'active' : ''; ?>"><a class="page-link" href="<?= base_url($link .  '?key=' . $dataContent['key'] . '&page=' . $i) ?>"><?= $i ?></a></li>
                        <?php } ?>
                        <li class="page-item"><a class="page-link" href="<?= base_url($link .  '?key=' . $dataContent['key'] . '&page=' . $dataContent['page'] + 1) ?>"><i class="fas fa-angle-right"></i></a></li>
                        <li class="page-item"><a class="page-link" href="<?= base_url($link . '?key=' . $dataContent['key'] . '&page=' . $dataContent['total_page']) ?>">Terakhir</a></li>
                    </ul>
