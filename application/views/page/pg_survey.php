			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 align-self-center p-static order-2 text-center">
						<h1 class="text-dark font-weight-bold text-8">E-Survei Penilaian Kepuasan Masyarakat</h1>
					</div>
					<div class="col-md-12 align-self-center order-1">
						<ul class="breadcrumb d-block text-center">
							<li>Home</li>
							<li class="active"> E-Survei </li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-9">
											...
											<div class="row">
												<div class="col-sm-4" id="sangat_puas">
													<div class="featured-box featured-box-primary featured-box-effect-3">
														<div class="box-content">
															<img class="icon-featured far fa-heart top-0" src="<?= base_url() ?>assets/img/sangat_puas.png">
												...
												<div class="col-sm-4" id="cukup_puas">
													<div class="featured-box featured-box-tertiary featured-box-effect-3 ">
														<div class="box-content">
															<img class="icon-featured far fa-heart top-0" src="<?= base_url() ?>assets/img/cukup_puas.png">
												...
												<div class="col-sm-4" id="tidak_puas">
													<div class="featured-box featured-box-secondary featured-box-effect-3">
														<div class="box-content">
															<img class="icon-featured far fa-heart top-0" src="<?= base_url() ?>assets/img/tidak_puas.png">
															<h4 class="font-weight-normal text-5 mt-3"><strong class="font-weight-extra-bold"></strong> Tidak Puas</h4>
														</div>
													</div>
												</div>
											</div>
					...
					<script>
						...
						sub_btn.on('click', () => {
							...
							$.ajax({
								method: 'POST',
								url: '<?= base_url('menu/submit_survey') ?>',
